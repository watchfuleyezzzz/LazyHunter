...
red="\033[35;1m"   
echo -e $red" X   XXXX XXXX X   X"
echo -e $red" X   X--X   X   X X "
echo -e $red" X   X  X  X     X  "
echo -e $red" XXX X  X XXXX   X  "
echo -e $red" BY 0Day-At0mik"
echo -e $red" X  X X  X X  X XXX XX XXX"
echo -e $red" X__X X  X XX X  X  X_ XXX"
echo -e $red" X  X X  X X XX  X  X  XX"
echo -e $red" X  X  XX  X  X  X  XX X X"
